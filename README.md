...
| **[deutsches-recht](./bundles/deutsches-recht/index.md)** | Curated, source-cited knowledge of German law (what the law actually says), as concepts grounded in the statutory text at gesetze-im-internet.de and cited to each §. Grows area by area; covers so far: **legal method**; the **whole civil law** (all five BGB books — general part, obligations incl. sales/tenancy/tort/enrichment/special contracts, property, family, succession), plus **commercial & company law** (HGB/GmbHG, incl. the 2024 MoPeG), **employment**, **residential tenancy** and **AGB control**; **criminal law** (general part and the core offences); and **public law** (constitutional, general administrative, social). German-language; statutory rules and settled doctrine, not a substitute for a specialist check. |
