...
| **[deutsches-recht](./bundles/deutsches-recht/index.md)** | Curated, source-cited knowledge of German private law (what the law actually says), as concepts grounded in the statutory text at gesetze-im-internet.de. Grows area by area; built so far: legal method (Anspruchsaufbau, Gutachtenstil, Auslegung), BGB General Part (Willenserklärung, Vertragsschluss, Geschäftsfähigkeit, Anfechtung, Stellvertretung, Form, Verjährung), the law of breach (§§ 280 ff.), sales law incl. the 2022 Sachmangel reform (§§ 433 ff.), and the control of standard business terms (AGB-Kontrolle, §§ 305 to 310). German-language. |
