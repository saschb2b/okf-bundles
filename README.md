...
| **[deutsches-recht](./bundles/deutsches-recht/index.md)** | German-language catalog of the 214 legal-practice plugins in [claude-fuer-deutsches-recht](https://github.com/Klotzkette/claude-fuer-deutsches-recht), one concept per plugin grouped into 25 legal domains (civil, criminal, commercial, public, tax, IP, social, procedure, professional conduct, and more). Each concept carries the plugin's coverage, a sample of its skills, cross-links to related plugins, and a link back to the source. A dated snapshot (v335.0.0); read the [source reference](./bundles/deutsches-recht/references/claude-fuer-deutsches-recht.md) for scope and disclaimers first. |
