...
Coined by Kahneman and Tversky (1979). The bias is asymmetric: people underestimate their own tasks but tend to overestimate others', so self-estimation is the worst case (an argument for team estimation). In one study, students predicted their thesis would take 33.9 days on average; the actual average was 55.5 days, worse than their own worst-case guess, and only about 30 percent finished within their own estimate.
