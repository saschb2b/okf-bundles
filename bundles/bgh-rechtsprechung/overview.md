...
- **Stapel-Ingestion:** Für den Massenbezug dient die offene, maschinenlesbare Bereitstellung von [rechtsprechung-im-internet.de](https://www.rechtsprechung-im-internet.de/) (Inhaltsverzeichnis `rii-toc.xml`, je Entscheidung eine ZIP mit einer XML nach `rii-dok.dtd`). Zwei Skripte im Repo führen das aus:
  ...
  - `scripts/ingest-bgh-pdf.mjs` ergänzt die Jahre vor 2010 aus der BGH-Entscheidungsdatenbank ([bundesgerichtshof.de](https://www.bundesgerichtshof.de/)), deren Entscheidungen als PDF vorliegen; die Suchtrefferliste liefert Senat, Datum, Aktenzeichen und PDF-Link, der Text wird mit `pdftotext` ausgelesen. Gleiches Pfadschema, daher überschneidungsfrei zum rii-Bestand.
...
Eingelesen sind die Jahre 2000 bis 2026 (rund 44.300 Entscheidungen) aus zwei amtlichen Quellen: 2010 bis 2026 aus der maschinenlesbaren rii-Quelle (rund 32.600, mit Leitsatz und strukturierten Normen), 2000 bis 2009 ergänzend aus der BGH-Entscheidungsdatenbank (bundesgerichtshof.de, rund 11.700, aus dem PDF gewonnen, mit knapperen Normangaben). Die Beschreibung der PDF-Entscheidungen stammt aus dem Leitsatz oder dem ersten Satz der Gründe. Je Entscheidung Metadaten und, soweit vorhanden, der Leitsatz; der Volltext steht bei der amtlichen Quelle (ein Klick). Die PDF-Quelle wird über eine paginierte Suche erschlossen, die zwischen Läufen leicht variiert und jene Jahre nur selektiv veröffentlicht; der Bestand für 2000 bis 2009 ist daher nach bestem Bemühen, nicht garantiert vollständig. Das bei jeder Entscheidung genannte Datum und Aktenzeichen sind der Weg zur amtlichen Gegenprüfung; jüngere oder abweichende Rechtsprechung ist dort zu suchen. Dies ist keine Rechtsberatung.
