...
Eine siebte Ebene liegt über allen anderen: die [Wochenplanung](/guide/wochenplanung.md). Sie beantwortet nicht „wie koche ich das", sondern „wie kommt eine ganze Woche zustande, ohne dass täglich stundenlang gekocht wird und ohne dass die Hälfte des Einkaufs verdirbt". Ihre Konzepte sind die [Wochenpläne](/wochenplaene/standardwoche.md), fertig gerechnete Sieben-Tage-Folgen mit Einkaufszettel, und sie sind **abgeleitetes Wissen**: sie hängen an den Gerichten, aus denen sie bestehen, und werden mit ihnen neu gerechnet.
