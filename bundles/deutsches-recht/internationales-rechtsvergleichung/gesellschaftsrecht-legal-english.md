...
rechtsgebiet: "Internationales Recht & Rechtsvergleichung"
skills: 53
version: "335.0.0"
...
`gesellschaftsrecht`, `corporate-legal-english`, `ma`, `venture-capital`, `startup`, `cap-table`, `term-sheet`, `shareholders-agreement`, `liquidation-preference`, `anti-dilution`, `vesting`, `drag-along`, `tag-along`, `due-diligence`.

# Skills (Auswahl)

Eine Auswahl der 53 enthaltenen Skills (vollständige Liste im [Quell-Repository](https://github.com/Klotzkette/claude-fuer-deutsches-recht/tree/main/gesellschaftsrecht-legal-english/skills)):

- `anfaenger-verhandlung-vergleich-und-eskalation`
- `anschauungsmaterial-multiformat-auswertung`
- `anti-dilution-articles-association`
- `articles-association-satzung`
- `begriffskompass-intake-bgb-at`
- `bgb-at-schuldrecht-at-im-ma`
- `business-corporate`
- `cap-table-client-explainer`
- `chronologie-fristen`
- `client-explainer-legal-english`

# Citations

[1] [plugin.json](https://github.com/Klotzkette/claude-fuer-deutsches-recht/blob/main/gesellschaftsrecht-legal-english/.claude-plugin/plugin.json)
[2] [Marketplace-Manifest](https://github.com/Klotzkette/claude-fuer-deutsches-recht/blob/main/.claude-plugin/marketplace.json)
