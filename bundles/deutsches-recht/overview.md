---
type: Overview
title: "Deutsches Recht: Katalog der Plugin-Sammlung"
description: Ein nach Rechtsgebieten geordneter Katalog der 214 Plugins aus claude-fuer-deutsches-recht, je Plugin ein Konzept mit Abdeckung, Skill-Auswahl und Rücklink in die Quelle.
tags: [deutsches-recht, katalog, claude-plugins]
timestamp: 2026-06-18T12:00:00Z
---

# Was das ist

Dieser Bundle erschließt die experimentelle Sammlung [claude-fuer-deutsches-recht](/references/claude-fuer-deutsches-recht.md): **214 Plugins** mit zusammen über **25.673 Skills** für die deutsche Rechtspraxis. Jedes Plugin ist hier ein eigenes Konzept mit seiner Beschreibung, der Normabdeckung, einer Auswahl seiner Skills und einem Rücklink in das Quell-Repository. Es ist ein **Navigations- und Entdeckungs-Layer**, nicht die Skill-Inhalte selbst.
...
- **Methodik zuerst.** Drei Querschnitts-Plugins tragen den deutschen Stil und werden überall vorausgesetzt: [Methodenlehre](/methodik-grundlagen/methodenlehre-buergerliches-recht.md), [Rechtstheorie](/methodik-grundlagen/rechtstheorie-rechtsphilosophie.md), [Zitierweise](/methodik-grundlagen/zitierweise-deutsches-recht.md).
- **Nach Rechtsgebiet stöbern.** Vom [Wurzelindex](/index.md) in ein Gebiet absteigen und dort das passende Plugin wählen.
- **Quelle und Grenzen.** Vor jeder Nutzung die [Hinweise zum Quell-Repository](/references/claude-fuer-deutsches-recht.md) lesen: Experiment, keine Rechtsberatung, alle Angaben ohne Gewähr.

# Stand

Datierter Snapshot vom 2026-06-18, Plugin-Arbeitsstand v335.0.0. Quelle: [claude-fuer-deutsches-recht](/references/claude-fuer-deutsches-recht.md).
