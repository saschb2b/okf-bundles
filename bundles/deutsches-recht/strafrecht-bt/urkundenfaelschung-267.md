---
type: Rechtsregel
title: "Urkundenfälschung (§ 267 StGB)"
description: Urkundenfälschung begeht, wer zur Täuschung im Rechtsverkehr eine unechte Urkunde herstellt, eine echte verfälscht oder eine solche gebraucht; geschützt ist die Echtheit, nicht die Wahrheit der Urkunde.
...
- eine **unechte Urkunde herstellt** (eine Urkunde, die nicht von dem stammt, der als Aussteller erscheint),
- eine **echte Urkunde verfälscht** (nachträgliche Veränderung des gedanklichen Inhalts durch einen Nichtberechtigten), oder
- eine unechte oder verfälschte Urkunde **gebraucht**,

wird bestraft. Der Versuch ist strafbar.

# Schutzgut und Urkundenbegriff
