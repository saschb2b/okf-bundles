...
1. **Start at the bundle-root `index.md`.** Read what exists before opening anything. That is [progressive disclosure](/practice/progressive-disclosure.md).
...
- [Authoring a bundle](/practice/authoring-a-bundle.md) is the producer's side.
