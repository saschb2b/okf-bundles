...
The shape generalizes past this example, and it is [the adoption path](/practice/adoption-path.md) made concrete. Most questions an agent gets wrong need the same five kinds of file:
...
- [Authoring a bundle](/practice/authoring-a-bundle.md) is the full procedure, including the bookkeeping that keeps a bundle from rotting.
- [Graph hygiene](/practice/graph-hygiene.md) covers the two defects a file checker misses.
- [Consuming a bundle](/practice/consuming-a-bundle.md) is how to point an agent at what you just wrote.
