...
An index that lags the directory is worse than none, because it asserts a listing a consumer will believe. Regenerating the affected index is part of [the bookkeeping](/practice/authoring-a-bundle.md) for every change that adds or renames a concept.

# Related

- [The index file](/spec/index-file.md) is the format.
- [Consuming a bundle](/practice/consuming-a-bundle.md) is the loop that uses it.
