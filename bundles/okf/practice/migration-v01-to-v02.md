...
- [ ] Run [the checker with `--strict`](validation.md), which flags leftover `timestamp` and `# Citations`.
...
- [Authoring a bundle](authoring-a-bundle.md) covers the ongoing bookkeeping after the migration.
