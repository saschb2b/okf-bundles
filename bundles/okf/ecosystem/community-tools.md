...
**Validation is the most duplicated work.** Independent linters exist in at least eight projects. That redundancy is the argument behind the conformance-corpus and `okf_profile` proposals in [open questions](open-questions.md).
...
- [State of adoption](adoption.md) reads these numbers as evidence.
