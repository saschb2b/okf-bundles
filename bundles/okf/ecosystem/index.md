...
Implementations, worked examples, the state of the community, and the formats OKF sits next to.
...
- [The okf skill](okf-skill.md) - An agent skill that carries the spec, twelve commands, narrow methods, implicit bookkeeping, and a zero-dependency validator.
- [OKF Studio](okf-studio.md) - A local-first desktop app that gives a machine-readable bundle a human window: graph, reader, agent, staged edits.
...
- [How OKF stacks with sitemap.xml and llms.txt](llms-txt-and-sitemap.md) - Three layers that answer different questions, plus ODSF, the design-system profile.

# Sources

- [The primary documents](../references/) - Spec and announcement.
