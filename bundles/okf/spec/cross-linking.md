...
`Bundle-absolute`
: Begins with `/`, resolved from the bundle root: `/tables/customers.md`. The **recommended** form, because it survives a file moving.
...
- [Concept ID](/spec/concept-id.md) is what a link resolves to.
- [The index file](/spec/index-file.md) is navigation, and is deliberately not a link target for a concept.
