...
3. Every reserved filename (`index.md`, `log.md`), where present, follows [the index](index-file.md) and [log](log-file.md) structure.
...
A consumer that does not understand the declared [version](versioning.md) **SHOULD** attempt best-effort consumption rather than refusing the bundle.
...
- [The concept document](concept-document.md) is what rule 2 applies to.
- [Design principles](design-principles.md) explains the minimal-opinion stance behind this bar.
