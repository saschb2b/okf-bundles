...
A bundle **MAY** declare its target version in the bundle-root `index.md` frontmatter, which is the only place [`index.md` frontmatter](index-file.md) is permitted:
...
- [Conformance](conformance.md) covers the best-effort rule for an unknown version.
