...
Two consequences follow. Filling the window is not the same as using it: pad the knowledge slice with everything that might be relevant, and you bury the page that mattered. Where a page lands is a real decision, part of [context assembly](context-assembly.md) rather than an implementation detail.
...
- [Context assembly](context-assembly.md) fills this window each turn.
- [The knowledge gap](knowledge-gap.md) is what the knowledge slice has to close.
